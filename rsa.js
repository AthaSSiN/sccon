...
function randE(n = 256) {
    return bignumber_1.BigNumber.from((0, random_1.randomBytes)(n)).mod(exports.RSA_MODULUS);
}
exports.randE = randE;
function randBigNumber(n) {
    return bignumber_1.BigNumber.from((0, random_1.randomBytes)(32));
}
...
function to256Bytes(input) {
    return (0, bytes_1.hexlify)((0, bytes_1.zeroPad)(input.toHexString(), 256));
}
exports.to256Bytes = to256Bytes;
function to512Bytes(input) {
    return (0, bytes_1.hexlify)((0, bytes_1.zeroPad)(input.toHexString(), 512));
}
exports.to512Bytes = to512Bytes;
function toBytes(input, n) {
    return (0, bytes_1.hexlify)((0, bytes_1.zeroPad)(input.toHexString(), n));
}
